        ...
        ghpages_command_context "build for jeweler" do
          context "Jeweler::Commands::Ghpages::RemoveFromGhpages" do
            setup do
              ...
              stub(@grancher).message=("Removing repo's gh-pages from http://user.github.com/repo")

              @output = Object.new
              stub(@output).puts("Removing repo's gh-pages from http://user.github.com/repo") { true }
            ...
            context "Jeweler::Commands::Ghpages::RemoveFromGhpages, def run()" do
              should "follow the default calling path" do
                ...
                assert_received(@output) do |should_receive| 
                  should_receive.puts("Removing repo's gh-pages from http://user.github.com/repo") { true }
                end
